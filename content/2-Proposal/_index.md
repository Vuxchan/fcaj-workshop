...
<img src="/images/2-Proposal/codexecute_platform_structure.jpg" alt="CodExecute Online Judge Platform Interface Overview" style="width: 95%; max-width: 1100px; border-radius: 8px; box-shadow: 0 6px 20px rgba(0,0,0,0.15);">
...
![CodExecute Architecture Diagram](/images/architect-codexecute.png)

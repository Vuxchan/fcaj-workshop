...
# CONNECT SQS QUEUE TO LAMBDA WORKER (EVENT SOURCE MAPPING)
...
1. Navigate to a problem in the frontend at [https://d1hsp5bm4hkjmb.cloudfront.net](https://d1hsp5bm4hkjmb.cloudfront.net).
